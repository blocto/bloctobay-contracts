...
import MintStoreItem from "../../contracts/NFTs/MintStore/MintStoreItem.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x8a5e1b5357d5dd84
        let nftRatio = 0.02
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@MintStoreItem.NFT>())
    }
}