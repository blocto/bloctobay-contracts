...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x1b0d0e046c306e2f
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@MotoGPCard.NFT>())
        admin.updateSaleCutRequirements(requirements, nftType: Type<@MotoGPPack.NFT>())
    }
}