...
import GoatedGoats from "../../contracts/NFTs/GoatedGoats/GoatedGoats.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0xd7081a5c66dc3e7f
        let nftRatio = 0.05
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@GoatedGoats.NFT>())
    }
}