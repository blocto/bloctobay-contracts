...
import MatrixWorldAssetsNFT from "../../contracts/NFTs/MatrixWorld/MatrixWorldAssetsNFT.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@MatrixWorldAssetsNFT.NFT>())
    }
}