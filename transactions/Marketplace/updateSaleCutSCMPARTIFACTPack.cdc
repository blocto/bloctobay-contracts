...
import ARTIFACTPack from "../../contracts/NFTs/SCMP/ARTIFACTPack.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0xe9e563d7021d6eda
        let nftRatio = 0.1
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@ARTIFACTPack.NFT>())
    }
}