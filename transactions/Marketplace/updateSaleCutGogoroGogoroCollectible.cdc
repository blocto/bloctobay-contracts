...
import GogoroCollectible from "../../contracts/NFTs/Gogoro/GogoroCollectible.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0xd01e3f256027107c
        let nftRatio = 0.1
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@GogoroCollectible.NFT>())
    }
}