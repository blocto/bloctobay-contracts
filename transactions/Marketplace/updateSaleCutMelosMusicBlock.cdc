...
import MusicBlock from "../../contracts/NFTs/Melos/MusicBlock.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x2cc8a18d77d5fa35
        let nftRatio = 0.03
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@MusicBlock.NFT>())
    }
}