...
import RacingTime from "../../contracts/NFTs/RacingTime/RacingTime.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0xcbae1f26d605f168
        let nftRatio = 0.04
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@RacingTime.NFT>())
    }
}