...
import Kicks from "../../contracts/NFTs/NFTLX/Kicks.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0xf3cc54f4d91c2f6c
        let nftRatio = 0.05
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@Kicks.NFT>())
    }
}