...
import TopShot from "../../contracts/NFTs/TopShot.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0xe2d0069d9353a406
        let nftRatio = 0.05 // 5%
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@TopShot.NFT>())
    }
}