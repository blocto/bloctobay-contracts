...
import CryptoPiggo from "../../contracts/NFTs/CryptoPiggos/CryptoPiggo.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x22bd73c547ce8add
        let nftRatio = 0.035
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@CryptoPiggo.NFT>())
    }
}