...
import OneFootballCollectible from "../../contracts/NFTs/OneFootball/OneFootballCollectible.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x6831760534292098
        let nftRatio = 0.01
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@OneFootballCollectible.NFT>())
    }
}