...
import BarterYardPackNFT from "../../contracts/NFTs/BarterYardClub/BarterYardPackNFT.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0xb07b788eb60b6528
        let nftRatio = 0.05
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@BarterYardPackNFT.NFT>())
    }
}