...
import CryptoZooNFT from "../../contracts/NFTs/InceptionAnimals/CryptoZooNFT.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x3564d691f3ae6103
        let nftRatio = 0.05
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@CryptoZooNFT.NFT>())
    }
}