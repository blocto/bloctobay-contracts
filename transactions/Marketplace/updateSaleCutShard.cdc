...
import Shard from "../../contracts/NFTs/Eternal/Shard.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x1f56a1e665826a52
        let nftRatio = 0.1
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@Shard.NFT>())
    }
}