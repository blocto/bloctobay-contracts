...
import Everbloom from "../../contracts/NFTs/Everbloom.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0xe703f7fee6400754
        let nftRatio = 0.05
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@Everbloom.NFT>())
    }
}