...
import DayNFT from "../../contracts/NFTs/DayNFT/DayNFT.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x1600b04bf033fb99
        let nftRatio = 0.05
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@DayNFT.NFT>())
    }
}