...
import CaaPass from "../../contracts/NFTs/ThingFund/CaaPass.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x4f664981c351a36e
        let nftRatio = 0.08
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@CaaPass.NFT>())
    }
}