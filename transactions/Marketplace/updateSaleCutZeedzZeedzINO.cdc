...
import ZeedzINO from "../../contracts/NFTs/Zeedz/ZeedzINO.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x04c6239d615a5a23
        let nftRatio = 0.05
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@ZeedzINO.NFT>())
    }
}