...
import GooberXContract from "../../contracts/NFTs/ThePartyGooberz/GooberXContract.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x34f2bf4a80bb0f69
        let nftRatio = 0.06
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@GooberXContract.NFT>())
    }
}