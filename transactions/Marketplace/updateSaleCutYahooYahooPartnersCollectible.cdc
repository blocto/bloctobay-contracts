...
import YahooPartnersCollectible from "../../contracts/NFTs/Yahoo/YahooPartnersCollectible.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@YahooPartnersCollectible.NFT>())
    }
}