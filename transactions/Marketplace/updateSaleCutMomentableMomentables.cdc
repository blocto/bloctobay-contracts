...
import Momentables from "../../contracts/NFTs/Momentable/Momentables.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x7dc1aa82a2f8d409
        let nftRatio = 0.1
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@Momentables.NFT>())
    }
}