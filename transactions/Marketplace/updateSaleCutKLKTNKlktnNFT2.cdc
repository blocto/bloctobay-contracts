...
import KlktnNFT2 from "../../contracts/NFTs/KLKTN/KlktnNFT2.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0xabd6e80be7e9682c
        let nftRatio = 0.075
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@KlktnNFT2.NFT>())
    }
}