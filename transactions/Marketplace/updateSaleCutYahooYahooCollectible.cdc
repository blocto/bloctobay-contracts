...
import YahooCollectible from "../../contracts/NFTs/Yahoo/YahooCollectible.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0xfcf3a236f4cd7dbc
        let nftRatio = 0.1
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@YahooCollectible.NFT>())
    }
}