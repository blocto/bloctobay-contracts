...
import GeniaceNFT from "../../contracts/NFTs/GENIACE/GeniaceNFT.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x0bfbaa1760ead010
        let nftRatio = 0.1
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@GeniaceNFT.NFT>())
    }
}