...
import NftReality from "../../contracts/NFTs/Reality/NftReality.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x4a37e76f5655349c
        let nftRatio = 0.02
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@NftReality.NFT>())
    }
}