...
import BlindBoxRedeemVoucher from "../../contracts/NFTs/FlowBlindBox/BlindBoxRedeemVoucher.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x77e38c96fda5c5c5
        let nftRatio = 0.0
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@BlindBoxRedeemVoucher.NFT>())
    }
}