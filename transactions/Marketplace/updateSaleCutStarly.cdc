...
import StarlyCard from "../../contracts/NFTs/StarlyCard.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x12c122ca9266c278
        let nftRatio = 0.1 // 10%
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@StarlyCard.NFT>())
    }
}