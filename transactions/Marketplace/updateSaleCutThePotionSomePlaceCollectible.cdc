...
import SomePlaceCollectible from "../../contracts/NFTs/ThePotion/SomePlaceCollectible.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0x8e2e0ebf3c03aa88
        let nftRatio = 0.1
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@SomePlaceCollectible.NFT>())
    }
}