...
import Mynft from "../../contracts/NFTs/Mynft.cdc"
...
transaction {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftRecipient: Address = 0xf6fcbef550d97aa5
        let nftRatio = 0.02
        ...
        admin.updateSaleCutRequirements(requirements, nftType: Type<@Mynft.NFT>())
    }
}