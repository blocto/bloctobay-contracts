...
transaction(
    ...
    prepare(signer: AuthAccount) {
        ...
        if signer.borrow<&ExampleNFT.Collection>(from: /storage/NFTCollection) == nil {
            signer.save(<- ExampleNFT.createEmptyCollection(), to: /storage/NFTCollection)
        ...
        self.exampleNFTCollection = signer.borrow<&ExampleNFT.Collection{NonFungibleToken.Receiver}>(from: /storage/NFTCollection)
    ...
    execute {
        ...
        Marketplace.removeListingWithIndexes(
